...
(typeof(window) === 'undefined' ? global : window).I18n.translations["km-KH"] = {
  "web": {
    ...
    "branding": {
      ...
      "powered_by": "Copyright %{service_name}"
    },
    "listing_card": {
    ...
    "listings": {
      ...
      "edit_listing_availability": "Edit Availability Calendar",
      "errors": {
        "availability": {
    ...
    "no_listings": {
      "sorry": "Sorry, no posts could be found for your search criteria.",
